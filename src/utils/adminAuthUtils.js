...
export const canModifyUser = (userToModify, currentAdmin = null) => {
  ...
  if (currentAdmin.role === 'superadmin') {
    ...
    if (userToModify.role === 'superadmin' && userToModify.id !== currentAdmin.id) {
      return false;
    }
    return true;
  }
...
export default { checkAdminToken, debugAdminAuth, hasAdminPermission, canModifyUser, needsTokenRefresh, saveAdminToLocalStorage, getAdminToken, clearAdminAuth, saveAdminAuth, refreshAdminAuth };