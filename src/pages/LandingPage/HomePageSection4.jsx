...
const HomePageSection4 = () => {
  ...
  const resources = [
    ...
    },
    {
      ...
      title: "FAQs",
      description:
        "Answers to commonly asked questions about our platform, services, and investment processes.",
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {resources.map((resource, index) => (
            ...
            >
              ...
              <p
                className={`${darkMode ? "text-gray-400" : "text-gray-600"} mb-5`}
              >
        ...
        >
          ...
          >
            Our team of investment experts is available to provide personalized
            advice and support to help you achieve your financial goals.
          </p>
          <Link
            to="/contact"
