...
const HomePage = () => {
  ...
  return (
    <div
      className={`flex flex-col min-h-screen ${darkMode ? "bg-gradient-to-b from-gray-900 to-gray-800" : "bg-gradient-to-b from-blue-50 to-white"}`}
    >
      <section
        className={`pt-20 pb-16 px-4 sm:px-6 lg:px-8 mx-auto max-w-7xl relative overflow-hidden ${
      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center relative z-10">
          ...
          >
            ...
            <p
              className={`text-lg mb-8 max-w-xl mx-auto md:mx-0 ${
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-20 relative z-10">
          ...
          >
            ...
            <p className={darkMode ? "text-gray-400" : "text-gray-600"}>
              Our investment plans are designed to maximize your returns while
          ...
          >
            ...
            <p className={darkMode ? "text-gray-400" : "text-gray-600"}>
              Advanced encryption and security measures to keep your investments
              and data protected.
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          <motion.div style={{ opacity, y }} className="text-center mb-16">
            ...
            >
              ...
              Brokers with their financial future. Our proven track record
              speaks for itself.
            </p>
          </motion.div>
      ...
      <section
        className={`py-16 px-4 ${darkMode ? "bg-gray-900/95" : "bg-white"}`}
      >
        <div className="max-w-7xl mx-auto">
      ...
      <section
        className={`py-24 px-4 ${
          darkMode
            ? "bg-gradient-to-br from-primary-900/80 to-gray-900"
            : "bg-gradient-to-br from-primary-100 to-blue-50"
        } relative overflow-hidden`}
      >
        <div className="absolute top-0 right-0 w-1/2 h-full opacity-10">
          <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
            <path
              fill={darkMode ? "#FFFFFF" : "#3B82F6"}
              d="M47.5,-61.7C59.9,-51.5,67.3,-35.1,71.2,-18.1C75.2,-1.1,75.7,16.5,68.3,29.8C60.9,43.1,45.6,52.2,30,58.1C14.3,64.1,-1.9,66.9,-19.7,64.5C-37.5,62.1,-56.9,54.5,-66.4,40.3C-75.9,26.2,-75.4,5.5,-70.8,-13.2C-66.1,-31.9,-57.3,-48.7,-44.1,-58.8C-30.8,-68.9,-13.1,-72.3,2.9,-75.9C18.9,-79.5,35.1,-71.9,47.5,-61.7Z"
