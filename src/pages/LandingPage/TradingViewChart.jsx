    ...
    <section className={`py-12 px-4 ${darkMode ? 'bg-gray-900' : 'bg-white'}`}>
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
          <h2 className={`text-2xl font-bold ${darkMode ? 'text-white' : 'text-gray-900'} mb-4 md:mb-0`}>
        ...
        <div className="relative">
          {loading && (
            <div className={`absolute inset-0 flex items-center justify-center ${darkMode ? 'bg-gray-800' : 'bg-gray-100'} rounded-lg z-10`}>
              <div className="flex flex-col items-center">
                <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-primary-500 mb-4"></div>
                <p className={darkMode ? 'text-gray-300' : 'text-gray-700'}>Loading chart data...</p>
              </div>
            </div>
          )}
        ...
        <p className={`mt-4 text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'} text-center`}>
