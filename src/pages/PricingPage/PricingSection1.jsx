...
const PricingSection1 = () => {
  ...
  return (
    <div
      className={`pt-28 pb-16 px-4 ${darkMode ? "bg-gray-900 text-white" : "bg-gray-50 text-gray-900"}`}
    >
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          >
            Transparent Pricing,{" "}
            <span className="text-primary-500">Exceptional Value</span>
          </h1>
          <p
            className={`text-lg max-w-3xl mx-auto mb-10 ${darkMode ? "text-gray-300" : "text-gray-600"}`}
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            >
              ...
              <Link
                to="/signup"
                className={`block w-full py-3 px-4 rounded-lg text-center transition-colors ${
                  darkMode
            ...
            >
              ...
              <Link
                to="/signup"
                className="block w-full py-3 px-4 rounded-lg text-center bg-primary-600 hover:bg-primary-700 text-white transition-colors"
              >
