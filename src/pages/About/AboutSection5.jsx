  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          className={`absolute -top-24 -right-24 w-96 h-96 ${darkMode ? "bg-primary-600/10" : "bg-primary-600/5"} rounded-full blur-3xl`}
        ></div>
        <div
          className={`absolute -bottom-24 -left-24 w-96 h-96 ${darkMode ? "bg-blue-600/10" : "bg-blue-600/5"} rounded-full blur-3xl`}
        ></div>
      </div>
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            >
              <h2
                className={`text-3xl md:text-4xl font-bold ${darkMode ? "text-white" : "text-gray-900"} mb-6`}
              >
                Join Thousands of Satisfied Investors
              </h2>

              <p
                className={`${darkMode ? "text-gray-300" : "text-gray-600"} text-lg mb-8`}
              >
              ...
              <div className="grid grid-cols-2 gap-6 mb-8">
                {stats.map((stat, index) => (
                  ...
                  >
                    <p className="text-primary-500 font-bold text-3xl mb-1">
                      {stat.value}
                    </p>
          ...
          >
            ...
            <form className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label
                    className={`block ${darkMode ? "text-gray-400" : "text-gray-600"} text-sm mb-1`}
                  >
                    First Name
                  </label>
                  <input
            ...
            >
              <p
                className={`${darkMode ? "text-gray-400" : "text-gray-600"} text-sm mb-4`}
              >
