...
const AboutSection3 = () => {
  ...
  return (
    <section
      className={`py-20 px-4 ${darkMode ? "bg-gradient-to-b from-gray-800 to-gray-900" : "bg-gradient-to-b from-gray-50 to-white"}`}
    >
      <div className="container mx-auto max-w-6xl">
        ...
        <div ref={ref} className="relative">
          {/* Timeline line */}
          <div
            className={`absolute left-1/2 transform -translate-x-1/2 h-full w-1 ${darkMode ? "bg-gray-700" : "bg-gray-200"} hidden md:block`}
          ></div>
            ...
            {timeline.map((item, index) => (
              ...
              >
                ...
                >
                  ...
                  <h3
                    className={`text-xl font-bold ${darkMode ? "text-white" : "text-gray-900"} mt-1 mb-2`}
                  >
                    {item.title}
                  </h3>
                ...
                <div
                  className={`md:hidden w-full h-px ${darkMode ? "bg-gray-700" : "bg-gray-200"} my-4`}
                ></div>

                <div
                  className={`w-10 h-10 bg-primary-600 rounded-full flex items-center justify-center relative z-10 md:absolute md:left-1/2 md:transform md:-translate-x-1/2`}
                >
