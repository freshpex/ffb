            ...
            <div className="text-gray-300 space-y-6">
              ...
              <div className="bg-gray-700/50 p-4 rounded-lg border-l-4 border-primary-500 mb-8">
                <div className="flex items-start">
                  ...
                  <p className="text-sm">
                    <strong>IMPORTANT NOTICE:</strong> These Terms of Service
                    govern your use of Fidelity First Brokers' trading services.
                    By accessing or using our services, you agree to be bound by
                    these terms. Trading financial instruments involves
                    significant risk and may result in the loss of your invested
                    capital. Please read these terms carefully and consider
              ...
              <section>
                ...
                <p>
                  Welcome to Fidelity First Brokers ("FFB," "we," "us," or
                  "our"). These Terms of Service ("Terms") constitute a legally
                  binding agreement between you and Fidelity First Brokers
              ...
              <section>
                ...
                <p>
                  ...
                  have the legal capacity to enter into a binding agreement. By
                  using our Platform, you represent and warrant that you meet
                  these eligibility requirements.
                </p>
                <p className="mt-2">
                  Our services are not available to residents of certain
                  jurisdictions where online trading is prohibited or
                  restricted. It is your responsibility to ensure that your use
                  of our Platform complies with the laws and regulations
                  applicable to you.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="mt-2">
                  ...
                  we suspect that your account is being used for unauthorized or
              ...
              <section>
                ...
                <p>
                  Fidelity First Brokers provides an online platform for trading
                  financial instruments, including but not limited to stocks,
                  cryptocurrencies, forex, and commodities. Our services
                  include:
                </p>
                ...
                <p className="mt-2">
                  All trading services are subject to applicable regulations and
                  may vary based on your location and account type.
                </p>
              </section>
              ...
              <section>
                ...
                <div className="bg-red-900/20 p-4 rounded-lg">
                  ...
                  <p className="mt-2">
                    ...
                    You may lose some or all of your invested capital. Never
                    invest money that you cannot afford to lose.
                  </p>
                  <p className="mt-2">
                    <strong className="text-red-400">Market volatility:</strong>{" "}
                    Financial markets can fluctuate rapidly, resulting in
                    substantial gains or losses in a short period.
                  </p>
                  <p className="mt-2">
                    <strong className="text-red-400">Leverage risk:</strong>{" "}
                    Trading with leverage can magnify both profits and losses.
              ...
              <section>
                ...
                <p>
                  We charge fees for certain services provided through our
                  Platform, including trading commissions, account maintenance
                  fees, and other service fees. Our fee structure is available
                  on our Platform and may be updated from time to time.
                </p>
                <p className="mt-2">
                  You are responsible for paying all fees associated with your
                  use of our Platform. All fees are non-refundable unless
                  otherwise stated in these Terms or required by applicable law.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  You may deposit funds into your account using the payment
                  methods available on our Platform. All deposits must be made
                  from accounts or payment methods in your name.
                </p>
                <p className="mt-2">
                  Withdrawal requests are subject to our verification
                  procedures. We reserve the right to request additional
                  information or documentation to verify your identity and the
                  source of funds before processing a withdrawal.
                </p>
                <p className="mt-2">
                  Withdrawal processing times may vary depending on the payment
                  method and other factors. We strive to process all withdrawal
              ...
              <section>
                ...
                <ul className="list-disc pl-6 mt-2 space-y-1">
                  ...
                  <li>
                    Engaging in market manipulation or other fraudulent
                    activities
                  </li>
                  <li>
                    Using automated systems or software to interact with our
                    Platform without our express permission
                  </li>
                  <li>
                    Attempting to access unauthorized areas of our Platform
                  </li>
                  <li>
              ...
              <section>
                ...
                <p>
                  ...
                  software, are the exclusive property of Fidelity First Brokers
                  or our licensors.
                </p>
                <p className="mt-2">
                  You may not copy, modify, distribute, sell, or lease any part
                  of our Platform without our express permission. You may not
              ...
              <section>
                ...
                <p className="mt-2">
                  By using our Platform, you consent to our collection and use
              ...
              <section>
                ...
                <p>
                  To the maximum extent permitted by applicable law, Fidelity
                  First Brokers and its affiliates, officers, directors,
                ...
                <p className="mt-2">
                  Our total liability for all claims related to these Terms
                  shall not exceed the amount of fees paid by you to us during
              ...
              <section>
                ...
                <p>
                  You agree to indemnify, defend, and hold harmless Fidelity
                  First Brokers and its affiliates, officers, directors,
              ...
              <section>
                ...
                <p className="mt-2">
                  ...
                  and requesting account closure. Upon termination, you remain
              ...
              <section>
                ...
                <p>
                  ...
                  Terms on our Platform. Your continued use of our Platform
                  after the posting of revised Terms constitutes your acceptance
                  of such changes.
                </p>
                <p className="mt-2">
                  We will provide notice of material changes to these Terms by
                  displaying a prominent notice on our Platform or sending you
              ...
              <section>
                ...
                <p className="mt-2">
                  ...
                  use of our Platform shall be resolved through binding
                  arbitration in accordance with the rules of [Arbitration
                  Organization]. The arbitration shall take place in [Location]
