    ...
    >
      ...
      <div className="bg-gray-800 shadow-md">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <Link to="/terms" className="flex items-center text-white bg-primary-700 hover:bg-primary-600 px-4 py-2 rounded-lg transition-colors">
          ...
          <div className="p-8 md:p-12">
            ...
            <div className="text-gray-300 space-y-6">
              ...
              <div className="bg-primary-900/30 p-4 rounded-lg border-l-4 border-primary-500 mb-8">
                <p className="text-sm">
                  <strong>At Fidelity First Brokers</strong>, we are committed to protecting your privacy and ensuring the security of your personal information. This Privacy Policy outlines how we collect, use, disclose, and safeguard your data when you use our platform and services. By accessing or using Fidelity First Brokers, you consent to the practices described in this policy.
                </p>
              </div>
              ...
              <section>
                ...
                <div className="space-y-3">
                  <h3 className="font-medium text-white">1.1 Personal Information</h3>
                  <p>
                  ...
                  <ul className="list-disc pl-6 space-y-1">
                    ...
                    <li>Identification documents (passport, driver's license, national ID)</li>
                    <li>Demographic information (date of birth, residential address)</li>
                    <li>Professional information (occupation, employer details)</li>
                    <li>Tax information (tax identification number, tax residency)</li>
                  </ul>
                  
                  <h3 className="font-medium text-white mt-4">1.2 Automatically Collected Information</h3>
                  <p>
                    When you use our platform, we automatically collect certain information, including:
                  </p>
                  <ul className="list-disc pl-6 space-y-1">
                    <li>Device information (IP address, browser type, operating system)</li>
                    <li>Usage data (pages visited, time spent on the platform, trading activities)</li>
                    <li>Location information (general location based on IP address)</li>
                    <li>Log data (access times, error reports)</li>
                    <li>Cookies and similar tracking technologies</li>
                  </ul>
                  
                  <h3 className="font-medium text-white mt-4">1.3 Information from Third Parties</h3>
                  <p>
              ...
              <section>
                ...
                <ul className="list-disc pl-6 mt-2 space-y-1">
                  ...
                  <li>To market our products and services to you (subject to your preferences)</li>
                </ul>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc pl-6 mt-2 space-y-2">
                  <li>
                    <strong>Service Providers:</strong> Third-party vendors who provide services on our behalf, such as payment processing, data analysis, email delivery, hosting, and customer service.
                  </li>
                  <li>
                    <strong>Financial Partners:</strong> Banks, payment processors, and other financial institutions necessary to facilitate transactions.
                  </li>
                  <li>
                    <strong>Identity Verification Services:</strong> Services that help us verify your identity and comply with anti-money laundering regulations.
                  </li>
                  <li>
                    <strong>Regulators and Authorities:</strong> Government authorities, regulatory bodies, law enforcement agencies when required by law or to protect our rights.
                  </li>
                  <li>
                    <strong>Business Partners:</strong> Companies with whom we partner to offer integrated services or promotions.
                  </li>
                  <li>
                    <strong>Professional Advisors:</strong> Lawyers, auditors, and other professional advisors in connection with the services they provide to us.
                  </li>
                </ul>
                <p className="mt-3">
              ...
              <section>
                ...
                <p className="mt-3">
                  While we strive to protect your personal information, no security system is impenetrable. We cannot guarantee the absolute security of your data transmitted to our platform.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  We use cookies and similar tracking technologies to collect information about your browsing activities on our platform. Cookies are small text files stored on your device that help us provide and improve our services.
                </p>
                <p className="mt-2">
                ...
                <ul className="list-disc pl-6 mt-2 space-y-1">
                  <li>
                    <strong>Essential cookies:</strong> Required for the operation of our platform (e.g., session management).
                  </li>
                  <li>
                    <strong>Analytical/performance cookies:</strong> Help us understand how visitors interact with our platform.
                  </li>
                  <li>
                    <strong>Functionality cookies:</strong> Remember your preferences and settings.
                  </li>
                  <li>
                    <strong>Targeting cookies:</strong> Deliver more relevant advertisements.
                  </li>
                </ul>
                <p className="mt-3">
              ...
              <section>
                ...
                <ul className="list-disc pl-6 mt-2 space-y-2">
                  ...
                  <li>
                    <strong>Right to Rectification:</strong> You may request that we correct inaccurate or incomplete information.
                  </li>
                  <li>
                    <strong>Right to Erasure:</strong> You may request that we delete your personal information in certain circumstances.
                  </li>
                  <li>
                    <strong>Right to Restrict Processing:</strong> You may request that we restrict the processing of your personal information.
                  </li>
                  <li>
                    <strong>Right to Data Portability:</strong> You may request a copy of your personal information in a structured, machine-readable format.
                  </li>
                  <li>
              ...
              <section>
                ...
                <p>
                  Fidelity First Brokers operates globally, and your personal information may be transferred to, stored, and processed in countries other than your country of residence. These countries may have different data protection laws than your country.
                </p>
                <p className="mt-2">
                  When we transfer your personal information internationally, we implement appropriate safeguards to ensure that your information receives an adequate level of protection, including:
                </p>
                <ul className="list-disc pl-6 mt-2 space-y-1">
              ...
              <section>
                ...
                <p className="mt-3">
                  When personal information is no longer necessary, we securely delete or anonymize it.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  We may send you marketing communications about our products and services that may be of interest to you. You can opt out of receiving marketing communications at any time by:
                </p>
                <ul className="list-disc pl-6 mt-2 space-y-1">
                ...
                <p className="mt-3">
                  Please note that even if you opt out of marketing communications, we may still send you non-marketing communications related to your account and our services.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  We may update this Privacy Policy from time to time to reflect changes in our practices or legal requirements. We will notify you of any material changes by posting the new Privacy Policy on our platform and updating the "Last Updated" date.
                </p>
                <p className="mt-2">
            ...
            <div className="mt-12 flex flex-col md:flex-row justify-between items-center border-t border-gray-700 pt-8">
              <div className="flex items-center mb-4 md:mb-0">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">We're committed to protecting your data</p>
                </div>
              </div>
              <Link 
                to="/terms"
