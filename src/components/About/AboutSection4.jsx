...
const AboutSection4 = () => {
  ...
  const partners = [
    { name: "Global Financial Exchange", logo: "/src/assets/images/partners/gfe.png", icon: <FaGlobe /> },
    { name: "Investment Banking Institute", logo: "/src/assets/images/partners/ibi.png", icon: <FaUniversity /> },
    { name: "Market Analysis Group", logo: "/src/assets/images/partners/mag.png", icon: <FaChartBar /> },
    { name: "International Traders Association", logo: "/src/assets/images/partners/ita.png", icon: <FaUserTie /> }
  ];
                ...
                <div className="h-60 bg-gray-700 relative">
                  {member.image ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center bg-primary-900/30">
                      <span className="text-5xl font-bold text-primary-500">{member.name.charAt(0)}</span>
                    </div>
                  )}
                </div>
