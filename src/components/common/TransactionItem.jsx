...
import { FaArrowRight, FaArrowDown, FaArrowUp, FaSpinner, FaCheckCircle, FaTimesCircle, FaExclamationTriangle } from 'react-icons/fa';
      ...
      <div className="p-4">
        <div className="flex justify-between items-center">
          ...
          <div className="text-right">
            <p className={`font-semibold ${type === 'deposit' ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
        ...
        <div className="px-4 py-3 bg-gray-50 dark:bg-gray-750 border-t border-gray-200 dark:border-gray-700">
          <div className="text-sm">
            <p className="mb-1">
              ...
              <span className="text-gray-900 dark:text-gray-300">{description}</span>
            </p>
              ...
              if (field === 'metadata' && metadata) {
                ...
                return (
                  <p key={field} className="mb-1">
                    ...
                    <span className="text-gray-900 dark:text-gray-300"> {transaction[field]}</span>
                  </p>
                );
              }
              return null;
