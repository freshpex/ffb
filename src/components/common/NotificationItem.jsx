...
import { FaBell, FaCheck, FaTimes, FaInfoCircle, FaExclamationTriangle } from 'react-icons/fa';
...
const NotificationItem = ({ notification, onRead, onDelete }) => {
  ...
  return (
    <div className={`px-4 py-3 border-b border-gray-700 hover:bg-gray-700/50 transition-colors ${read ? 'opacity-60' : ''}`}>
