...
const DashBoardPage = () => {
  ...
  const dashboardStatus = useSelector((state) =>
    selectDashboardStatus(state, "dashboard"),
  );
  const financialHighlightsStatus = useSelector((state) =>
    selectDashboardStatus(state, "financialHighlights"),
  );
  const marketPulseStatus = useSelector((state) =>
    selectDashboardStatus(state, "marketPulse"),
  );

  const dashboardError = useSelector((state) =>
    selectDashboardError(state, "dashboard"),
  );
