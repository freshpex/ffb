      ...
      >
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
          <h1 className="text-2xl md:text-3xl font-bold text-white flex items-center">
            <FaGraduationCap className="mr-3 text-primary-500" /> Education
            Center
          </h1>
                ...
                >
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    ...
                    <div>
                      ...
                      <select className="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent text-white">
        ...
        <AnimatePresence mode="wait">
          ...
          {activeTab === "bookmarks" && (
            ...
            >
              <div>
                <h2 className="text-xl font-semibold text-white mb-4 flex items-center">
                  <FaBookmark className="mr-2 text-primary-500" /> Your
                  Bookmarks
                </h2>
                <div className="space-y-4">
                  {bookmarks.length > 0 ? (
                    ...
                    <div className="bg-gray-800 p-8 rounded-lg text-center">
                      ...
                      <p className="text-gray-400 mb-4">
                        Save resources for quick access by clicking the bookmark
                        icon.
                      </p>
