...
const TaskItem = ({ task, onStart, onClaim, actionLoading }) => {
  ...
  const progressWidth = task.userProgress
    ...
    <div className="p-6 bg-gray-800 hover:bg-gray-750 transition-colors duration-150">
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
          ...
          <div className="min-w-[140px]">{renderActionButton()}</div>
        </div>
      </div>
              ...
              <ul className="text-gray-400 space-y-1">
                ...
                {task.maxCompletions > 0 && (
                  <li className="flex items-center">
                    ...
                    Can be completed: {task.maxCompletions}{" "}
                    {task.maxCompletions === 1 ? "time" : "times"}
                  </li>
                )}
                {task.userProgress && (
                  <li className="flex items-center">
                    ...
                    Started:{" "}
                    {new Date(task.userProgress.startedAt).toLocaleDateString()}
                  </li>
                )}
              </ul>
            </div>
