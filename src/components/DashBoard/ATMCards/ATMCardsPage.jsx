    ...
    <DashboardLayout>
      <div className="p-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
          <h1 className="text-2xl md:text-3xl font-bold text-white mb-4 md:mb-0">Payment Cards</h1>
          ...
          <>
            ...
            <div className="mb-12">
              ...
              {cards.length > 0 ? (
                ...
                <div className="bg-gray-800 rounded-lg p-6 text-center border border-gray-700">
                  ...
                  <p className="text-gray-400 mb-6">You don't have any payment cards yet. Request your first card to start spending.</p>
                  <Button onClick={() => setIsModalOpen(true)}>Request Your First Card</Button>
                </div>
              )}
            </div>
            ...
            <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
              ...
              <div className="text-gray-300 space-y-4">
                <p>Our payment cards are designed to provide you with convenient access to your funds while ensuring maximum security for your transactions.</p>
                <p>Virtual cards are issued instantly and can be used for online purchases. Physical cards are typically delivered within 7-10 business days after approval.</p>
                <p>All transactions are protected by state-of-the-art security measures, and you can manage your cards directly from your dashboard.</p>
              </div>
            </div>
          </>
        )}
