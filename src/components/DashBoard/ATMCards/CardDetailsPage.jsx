          ...
          {status === "loading" ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-400 mb-6">
                The card you're looking for doesn't exist or you don't have
                access to it.
              </p>
          ...
          <div className="col-span-1">
            <div className="h-64 w-full perspective-1000">
              ...
              >
                ...
                >
                  <div
                    className={`${cardDesigns[card.type] || "bg-gradient-to-r from-gray-700 to-gray-900"} p-6 relative h-full`}
                  >
                    {card.status === "frozen" && (
                    ...
                    <div className="mt-4 flex justify-between items-end">
                      <div>
                        <p className="text-gray-200/70 text-xs mb-1">
                          Card Holder
                        </p>
                ...
                >
                  <div
                    className={`${cardDesigns[card.type] || "bg-gradient-to-r from-gray-700 to-gray-900"} p-0 relative h-full`}
                  >
                    ...
                    <div className="p-6">
                      ...
                      <div className="mt-6 text-xs text-gray-200/80">
                        <p>
                          This card is property of Fidelity First Bank. If
                          found, please return to the nearest branch.
                        </p>
                        <p className="mt-2">
                          For customer service, please call: 1-800-123-4567
                        </p>
                      </div>
                ...
                <div className="bg-gray-700/50 p-3 rounded-lg">
                  ...
                  <div className="mt-1 h-1 bg-gray-600 rounded-full overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${card.limits?.daily ? ((card.limits?.dailyUsed || 0) / card.limits?.daily) * 100 : 0}%`,
                      }}
                    ></div>
                  </div>
                ...
                <div className="bg-gray-700/50 p-3 rounded-lg">
                  ...
                  <div className="mt-1 h-1 bg-gray-600 rounded-full overflow-hidden">
                    <div
                      className="bg-primary-400 h-full"
                      style={{
                        width: `${card.limits?.monthly ? ((card.limits?.monthlyUsed || 0) / card.limits?.monthly) * 100 : 0}%`,
                      }}
                    ></div>
                  </div>
                  <p className="text-xs text-gray-500 mt-1">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-gray-700/50 p-4 rounded-lg flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-white text-xl font-semibold">
                      $
                      {spendingMetrics.monthlySpending.toLocaleString(
                        undefined,
                ...
                <div className="bg-gray-700/50 p-4 rounded-lg flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-white text-xl font-semibold">
                      $
                      {spendingMetrics.atmWithdrawals.toLocaleString(
                        undefined,
                        { minimumFractionDigits: 2, maximumFractionDigits: 2 },
                      )}
                    </p>
                ...
                <div className="bg-gray-700/50 p-4 rounded-lg flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-white text-xl font-semibold">
                      {spendingMetrics.totalTransactions}
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  {spendingMetrics.categoryBreakdown.map((category) => (
                    ...
                    >
                      <div className="flex items-center mb-2">
                        <div
                          className={`bg-${category.category === "shopping" ? "red" : category.category === "food" ? "yellow" : "green"}-600/30 text-${category.category === "shopping" ? "red" : category.category === "food" ? "yellow" : "green"}-400 p-2 rounded-lg mr-2`}
                        >
