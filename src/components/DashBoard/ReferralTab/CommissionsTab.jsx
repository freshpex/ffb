    ...
    <div>
      ...
      <div className="mt-6 bg-gray-800 border border-gray-700 rounded-lg p-4">
        ...
        <ul className="list-disc list-inside space-y-2 text-gray-300 pl-4 text-sm">
          <li>
            You earn {stats.commissionRate}% on all deposits made by your
            referrals.
          </li>
          <li>
            Trading commissions are paid instantly when your referral makes a
            trade.
          </li>
          <li>Deposit commissions are paid after a 24-hour holding period.</li>
          <li>
            Withdrawal requests for commission earnings are processed within 1-2
            business days.
          </li>
