        ...
        >
          <div className="mb-6 text-center">
            ...
            <p className="text-gray-400">
              Your deposit request has been successfully submitted. Admin will
              approve it soon.
            </p>
          </div>
          ...
          <div className="space-y-4 mb-6">
            ...
            <div className="flex justify-between py-2 border-b border-gray-700">
              ...
              <span className="text-white font-medium flex items-center">
                ...
                <span className="ml-2">
                  {pendingDeposit.cryptoType
                    ? activeMethod?.cryptoOptions?.find(
                        (c) => c.id === pendingDeposit.cryptoType,
                      )?.name || pendingDeposit.cryptoType
            ...
            <div className="flex justify-between py-2 border-b border-gray-700">
              ...
              <span className="text-white font-medium">
                {new Date(
                  pendingDeposit.createdAt || Date.now(),
                ).toLocaleString()}
              </span>
            </div>
      ...
      >
        ...
        <div className="bg-gray-900 rounded-lg shadow-lg overflow-hidden">
          <div className="p-6">
                ...
                >
                  <div className="bg-gray-800 p-5 rounded-lg">
                    <h3 className="text-lg font-medium text-white mb-4 flex items-center">
                      ...
                      <span className="ml-2">
                        {selectedCrypto.name} Deposit Instructions
                      </span>
                    </h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <p className="text-gray-300 mb-4">
                          Please send your {selectedCrypto.name} to the address
                          below. After sending, enter the transaction ID to
                        ...
                        <div className="bg-gray-700/50 p-4 rounded-lg mb-4">
                          <div className="mb-2">
                            ...
                            <div className="flex items-center mt-1">
                              <span className="text-sm text-white font-medium break-all mr-2">
                                {selectedCrypto.address}
                              </span>
                              <button
                                onClick={() =>
                                  handleCopyToClipboard(selectedCrypto.address)
                                }
                        ...
                        <div className="bg-blue-900/20 border border-blue-800 rounded-lg p-4 text-sm text-blue-300 flex items-start">
                          ...
                          <p>
                            ...
                            {selectedCrypto.confirmations} network
                            confirmations. Do not send any other cryptocurrency
                            to this address.
                          </p>
                        </div>
                      </div>
            ...
            {/* Deposit Form */}
            {activeMethod &&
              (activeMethod.id !== "cryptocurrency" || selectedCrypto) && (
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      {activeMethod.id === "cryptocurrency" && (
                        <div className="flex justify-between">
                          ...
                          <span className="text-white">
                            After {selectedCrypto?.confirmations || "required"}{" "}
                            confirmations
                          </span>
                        </div>
                      )}
