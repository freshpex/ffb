...
import { fetchKycRequests, selectKycRequests, selectKycPagination, selectKycStatus } from '../../redux/slices/adminKycSlice';
          ...
          <div>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="flex flex-col gap-1">
                              {kyc.documents.map((doc, index) => (
                                <span key={index} className={`text-xs ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                                  <FaIdCard className="inline mr-1" /> {doc.type.replace('_', ' ')}
                                </span>
                              ))}
                            </div>
                          </td>
            ...
            <div className={`mt-6 grid grid-cols-1 md:grid-cols-4 gap-4 ${
              ...
              <div className={`p-4 rounded-lg ${
                ...
                <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase mb-2">Pending</h3>
              ...
              <div className={`p-4 rounded-lg ${
                ...
                <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase mb-2">Approved</h3>
              ...
              <div className={`p-4 rounded-lg ${
                ...
                <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase mb-2">Rejected</h3>
              ...
              <div className={`p-4 rounded-lg ${
                ...
                <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase mb-2">Total</h3>
