            ...
            <div className="grid grid-cols-4 gap-3">
              <div className="col-span-1">
                <div className="flex flex-col items-center">
                  ...
                  <span
                    className={`mt-2 px-2 py-1 text-xs font-medium rounded-full ${visitor.convertedToUser ? "bg-green-100 text-green-800" : "bg-blue-100 text-blue-800"}`}
                  >
        ...
        <thead className={darkMode ? "bg-gray-800" : "bg-gray-50"}>
          <tr>
            ...
            <th
              scope="col"
              className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer"
              onClick={() => handleSort("locationInfo.country")}
            >
              <div className="flex items-center">
                Location
            ...
            <th
              scope="col"
              className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer"
              onClick={() => handleSort("convertedToUser")}
            >
              <div className="flex items-center">
                Status
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-red-700">
                  {error || "Failed to load visitors. Please try again."}
                </p>
              </div>
            </div>
          </div>
                ...
                <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                  <div className="sm:flex sm:items-start">
                    <div className="mt-3 text-center sm:mt-0 sm:text-left w-full">
                      ...
                      {selectedVisitorStatus === "succeeded" &&
                        selectedVisitor && (
                          <div>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                              <div className="bg-gray-50 p-4 rounded-lg">
                                ...
                                <dl className="grid grid-cols-2 gap-y-2">
                                  ...
                                  <dd className="text-right">
                                    <span
                                      className={`px-2 py-1 text-xs font-medium rounded-full ${selectedVisitor.convertedToUser ? "bg-green-100 text-green-800" : "bg-blue-100 text-blue-800"}`}
                                    >
                              ...
                              <div className="bg-gray-50 p-4 rounded-lg">
                                ...
                                <dl className="grid grid-cols-2 gap-y-2">
                                  ...
                                  <dd className="text-sm text-gray-900 text-right">
                                    {selectedVisitor.browserInfo?.deviceType ||
                                      "Unknown"}
                                  </dd>
                                  ...
                                  <dd className="text-sm text-gray-900 text-right">
                                    {selectedVisitor.browserInfo?.browser ||
                                      "Unknown"}
                                  </dd>
                                  ...
                                  <dd className="text-sm text-gray-900 text-right">
                                    {selectedVisitor.browserInfo?.os ||
                                      "Unknown"}
                                  </dd>
                                  ...
                                  <dd className="text-sm text-gray-900 text-right">
                                    {selectedVisitor.browserInfo?.screenWidth ||
                                      "?"}{" "}
                                    x{" "}
                                    {selectedVisitor.browserInfo
                                      ?.screenHeight || "?"}
                                  </dd>
                                  ...
                                  <dd className="text-sm text-gray-900 text-right">
                                    {selectedVisitor.browserInfo?.platform ||
                                      "Unknown"}
                                  </dd>
                                </dl>
                              </div>
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <dl className="grid grid-cols-2 gap-y-2">
                                  ...
                                  <dd className="text-sm text-gray-900 text-right flex items-center justify-end">
                                    ...
                                    {selectedVisitor.locationInfo?.country ||
                                      "Unknown"}
                                  </dd>
                                  ...
                                  <dd className="text-sm text-gray-900 text-right">
                                    {selectedVisitor.locationInfo?.city ||
                                      "Unknown"}
                                  </dd>
                                </dl>
                                ...
                                <dl className="grid grid-cols-2 gap-y-2">
                                  ...
                                  <dd className="text-sm text-gray-900 text-right">
                                    {selectedVisitor.locationInfo?.region ||
                                      "Unknown"}
                                  </dd>
                                  ...
                                  <dd className="text-sm text-gray-900 text-right">
                                    {selectedVisitor.locationInfo?.ip ||
                                      "Unknown"}
                                  </dd>
                                </dl>
                              </div>
