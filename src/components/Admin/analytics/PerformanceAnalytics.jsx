...
const PerformanceAnalytics = () => {
  ...
  const status = useSelector(state => selectAnalyticsStatus(state, 'performance'));
  const error = useSelector(state => selectAnalyticsError(state, 'performance'));
  ...
  const getInverseMetricColor = (value, thresholds = { high: 70, medium: 30 }) => {
    if (value <= thresholds.medium) return '#10B981'; // Green
  ...
  const prepareBreadthData = () => {
    ...
    return [
      ...
      {
        name: 'Active (90d)',
        value: performanceData.userActivity.activeUsersLast90Days - 
               performanceData.userActivity.activeUsersLast30Days,
        fill: '#3B82F6' // Blue
      },
      {
        name: 'Inactive',
        value: performanceData.userActivity.totalActiveUsers - 
  ...
  const preparePerformanceMetrics = () => {
    ...
    return [
      ...
      },
      {
        ...
        fill: getMetricColor(performanceData.system.uptime, { low: 95, medium: 99 })
      },
      {
        name: 'Error Rate',
    ...
    return (
      <div className="bg-gray-800 rounded-lg shadow-md p-4 md:p-6">
        <div className="bg-red-900/30 border-l-4 border-red-500 p-4">
          <p className="text-red-400">Error loading performance analytics: {error}</p>
          <button 
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        ...
        <div className="bg-gray-700/50 rounded-lg p-4 border border-gray-600/50">
          <div className="flex items-start justify-between">
            ...
            <div className="text-right">
              <p className="text-white text-xl font-semibold">
                {performanceData.system.averageApiResponseTime} <span className="text-sm font-normal">ms</span>
              </p>
              <p className="text-sm text-gray-400 mt-1">
                Avg. Response Time
              </p>
          ...
          <div className="mt-2">
            <div className="flex justify-between items-center text-xs text-gray-400 mb-1">
              ...
              <span className={performanceData.system.errorRate < 0.01 ? 'text-green-400' : 'text-amber-400'}>
            ...
            <div className="w-full bg-gray-600 rounded-full h-1.5">
              <div 
                ...
                style={{ 
                  ...
                  backgroundColor: getMetricColor(100 - performanceData.system.errorRate * 100)
                }}
              ></div>
            </div>
          </div>
        ...
        <div className="bg-gray-700/50 rounded-lg p-4 border border-gray-600/50">
          <div className="flex items-start justify-between">
            ...
            <div className="text-right">
              <p className="text-white text-xl font-semibold">
                {formatTime(performanceData.userActivity.averageSessionDuration, 'minutes')}
              </p>
              <p className="text-sm text-gray-400 mt-1">
                Avg. Session Time
              </p>
          ...
          <div className="mt-2">
            <div className="flex justify-between items-center text-xs text-gray-400 mb-1">
              ...
              <span className={performanceData.userActivity.retentionRate > 50 ? 'text-green-400' : 'text-amber-400'}>
            ...
            <div className="w-full bg-gray-600 rounded-full h-1.5">
              <div 
                ...
                style={{ 
                  ...
                  backgroundColor: getMetricColor(performanceData.userActivity.retentionRate)
                }}
              ></div>
            </div>
          </div>
        ...
        <div className="bg-gray-700/50 rounded-lg p-4 border border-gray-600/50">
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-white text-2xl font-semibold mt-1">
                {formatTime(performanceData.operations.ticketResponseTime, 'minutes')}
              </p>
              <p className="text-sm text-gray-400 mt-1">
                Avg. Ticket Response
              </p>
            ...
            <div className="text-right">
              <p className="text-white text-xl font-semibold">
                {formatTime(performanceData.operations.kycProcessingTime, 'hours')}
              </p>
              <p className="text-sm text-gray-400 mt-1">
                Avg. KYC Processing
              </p>
          ...
          <div className="mt-2">
            <div className="flex justify-between items-center text-xs text-gray-400 mb-1">
              ...
              <span>{formatTime(performanceData.operations.ticketResolutionTime, 'hours')}</span>
            </div>
            <div className="w-full bg-gray-600 rounded-full h-1.5">
              <div 
