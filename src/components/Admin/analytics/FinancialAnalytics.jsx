...
const FinancialAnalytics = () => {
  ...
  const status = useSelector((state) =>
    selectAnalyticsStatus(state, "financial"),
  );
  const error = useSelector((state) =>
    selectAnalyticsError(state, "financial"),
  );
        ...
        <div className="h-72 bg-gray-700/50 rounded-lg p-4 border border-gray-600/50">
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              />
              <Bar dataKey="Deposit Total" fill={colors.deposit} barSize={20} />
              <Bar
                dataKey="Withdrawal Total"
                fill={colors.withdrawal}
                barSize={20}
              />
              <Bar dataKey="Revenue" fill={colors.revenue} barSize={20} />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </div>
            ...
            <div className="bg-gray-800/80 rounded-lg p-4 border border-gray-700/50">
              ...
              <div className="w-full bg-gray-600 rounded-full h-2">
                <div
                  ...
                  style={{
                    width: `${financialData.metrics.depositSuccessRate}%`,
                  }}
                ></div>
              </div>
            </div>
            ...
            <div className="bg-gray-800/80 rounded-lg p-4 border border-gray-700/50">
              ...
              <div className="w-full bg-gray-600 rounded-full h-2">
                <div
                  ...
                  style={{
                    width: `${financialData.metrics.withdrawalSuccessRate}%`,
                  }}
                ></div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 gap-6">
            ...
            {financialData.metrics.depositMethods.length > 0 ? (
                ...
                <div className="overflow-y-auto max-h-40">
                  <table className="min-w-full">
                    ...
                    <tbody className="divide-y divide-gray-700">
                      {financialData.metrics.depositMethods.map(
                        (method, index) => (
              ...
              <div className="h-40 flex items-center justify-center">
                <p className="text-gray-400">
                  No deposit methods data available
                </p>
              </div>
            )}
          </div>
          ...
          <div className="bg-gray-700/50 rounded-lg p-4 border border-gray-600/50">
            ...
            {financialData.metrics.withdrawalMethods.length > 0 ? (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="overflow-y-auto max-h-40">
                  <table className="min-w-full">
                    ...
                    <tbody className="divide-y divide-gray-700">
                      {financialData.metrics.withdrawalMethods.map(
                        (method, index) => (
                          <tr key={method.method}>
                            <td className="py-1 text-sm whitespace-nowrap text-gray-300 flex items-center">
                              <div
              ...
              <div className="h-40 flex items-center justify-center">
                <p className="text-gray-400">
                  No withdrawal methods data available
                </p>
              </div>
            )}
          </div>
