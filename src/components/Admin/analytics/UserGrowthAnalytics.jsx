...
const UserGrowthAnalytics = () => {
  ...
  const status = useSelector((state) =>
    selectAnalyticsStatus(state, "userGrowth"),
  );
  const error = useSelector((state) =>
    selectAnalyticsError(state, "userGrowth"),
  );
            ...
            <div className="bg-gray-800/80 rounded-lg p-3 border border-gray-700/50">
              ...
              <div className="w-full bg-gray-600 rounded-full h-2 mt-2">
                <div
                  ...
                  style={{
                    width: `${userGrowthData.conversion.verificationRate}%`,
                  }}
                ></div>
              </div>
            </div>
            ...
            <div className="bg-gray-800/80 rounded-lg p-3 border border-gray-700/50">
              ...
              <div className="w-full bg-gray-600 rounded-full h-2 mt-2">
                <div
                  ...
                  style={{
                    width: `${userGrowthData.conversion.kycSubmissionRate}%`,
                  }}
                ></div>
              </div>
            </div>
            ...
            <div className="bg-gray-800/80 rounded-lg p-3 border border-gray-700/50">
              ...
              <div className="w-full bg-gray-600 rounded-full h-2 mt-2">
                <div
                  ...
                  style={{
                    width: `${userGrowthData.conversion.kycApprovalRate}%`,
                  }}
                ></div>
              </div>
            </div>
            ...
            <div className="bg-gray-800/80 rounded-lg p-3 border border-gray-700/50">
              ...
              <div className="w-full bg-gray-600 rounded-full h-2 mt-2">
                <div
                  ...
                  style={{
                    width: `${userGrowthData.conversion.depositConversionRate}%`,
                  }}
                ></div>
              </div>
            </div>
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
                    <Pie
                      ...
                      labelLine={false}
                    >
                      {userGrowthData.demographics.byCountry.map(
                        (entry, index) => (
                          <Cell
                            key={`cell-${index}`}
                ...
                <div className="overflow-y-auto max-h-56">
                  <table className="min-w-full">
                    ...
                    <tbody className="divide-y divide-gray-700">
                      {userGrowthData.demographics.byCountry
                        .slice(0, 8)
                        .map((country, index) => (
