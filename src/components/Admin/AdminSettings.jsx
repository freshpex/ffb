...
const AdminSettings = () => {
  ...
  const handleSaveSettings = () => {
    const settingsToUpdate = Object.entries(editedSettings).map(
      ([key, value]) => ({
        key,
        value,
      }),
  ...
  const renderSettingInput = (setting, key) => {
    const currentValue =
      editedSettings[key] !== undefined ? editedSettings[key] : setting.value;
    ...
    <PageTransition>
      <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          {/* Settings Content */}
          <div
            className={`rounded-lg lg:col-span-3 ${
              darkMode
                ? "bg-gray-800 border border-gray-700"
                : "bg-white shadow-md"
            }`}
            ...
            <div className="p-6">
              {status === "loading" ? (
                ...
                <div className="text-center py-10">
                  <FaCog
                    className={`mx-auto h-12 w-12 mb-4 ${darkMode ? "text-gray-600" : "text-gray-400"}`}
                  />
                  <h3
                    className={`text-lg font-medium mb-1 ${darkMode ? "text-white" : "text-gray-900"}`}
                  >
                ...
                <>
                  <div className="space-y-6">
                    {Object.entries(currentCategorySettings).map(
                      ([key, setting]) => (
                        <div
                          key={key}
                        ...
                        >
                          ...
                          <div className="mt-3">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
                              ...
                              <div>{renderSettingInput(setting, key)}</div>
                            </div>
                          </div>
                        </div>
                      ),
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleNewSettingChange("key", e.target.value)
                      }
                      className={`rounded-md w-full ${
                        darkMode
                          ? "bg-gray-700 border-gray-600 text-white"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleNewSettingChange("description", e.target.value)
                      }
                      className={`rounded-md w-full ${
                        darkMode
                          ? "bg-gray-700 border-gray-600 text-white"
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        handleNewSettingChange("type", e.target.value)
                      }
                      className={`rounded-md w-full ${
                        darkMode
                          ? "bg-gray-700 border-gray-600 text-white"
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        handleNewSettingChange("category", e.target.value)
                      }
                      className={`rounded-md w-full ${
                        darkMode
                          ? "bg-gray-700 border-gray-600 text-white"
                  ...
                  <div>
                    ...
                    {newSetting.type === "boolean" ? (
                      <div className="flex items-center">
                        <label className="inline-flex items-center cursor-pointer">
                          <input
                            ...
                            onChange={(e) =>
                              handleNewSettingChange("value", e.target.checked)
                            }
                          />
                          <div
                            className={`w-11 h-6 rounded-full peer 
                      ...
                      <textarea
                        ...
                        onChange={(e) =>
                          handleNewSettingChange("value", e.target.value)
                        }
                        rows="3"
                        className={`rounded-md w-full ${
                          darkMode
