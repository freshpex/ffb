      ...
      <div>
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label
                className={`block text-xs mb-1 ${darkMode ? "text-gray-400" : "text-gray-600"}`}
              >
                From
              </label>
              <input
                        ...
                        >
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="flex items-center">
                              <div
                                className={`p-2 rounded-full mr-3 ${getTransactionBgColor(transaction.type)}`}
                              >
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                >
                  ...
                  <p
                    className={`mt-1 text-xl font-semibold ${darkMode ? "text-blue-400" : "text-blue-600"}`}
                  >
                    {formatCurrency(
                      transactions
