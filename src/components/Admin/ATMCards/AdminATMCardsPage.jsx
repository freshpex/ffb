...
const AdminATMCardsPage = () => {
  ...
  const handleApproveCard = async (cardId) => {
    try {
      ...
      dispatch(fetchAdminCards({
        page: currentPage,
        limit: 10,
        status: activeTab === 'requests' ? 'pending' : 
               activeTab === 'active' ? 'active,processing,shipped' : '',
        ...filters
      }));
    } catch (err) {
      setAlertMessage({
      ...
      <div className="p-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
          ...
          <div className="flex space-x-2">
            ...
            <Button 
              variant="primary"
              onClick={() => dispatch(fetchAdminCards({
                page: currentPage,
                limit: 10,
                status: activeTab === 'requests' ? 'pending' : 
                      activeTab === 'active' ? 'active,processing,shipped' : '',
            ...
            <div className="bg-gray-800 rounded-lg border border-gray-700 overflow-hidden">              
              {displayCards && displayCards.length > 0 ? (
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="flex items-center">
                              <div>
                                ...
                                <div className="text-sm text-gray-400">{card.user?.email || 'N/A'}</div>
                              </div>
                            </div>
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap">
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-400">No card requests matching your filters were found.</p>
                </div>
              )}
