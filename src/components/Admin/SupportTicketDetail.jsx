...
const SupportTicketDetail = () => {
  ...
  if (status === "loading") {
    return (
      <ComponentLoader height="500px" message="Loading ticket details..." />
    );
  }
    ...
    return (
      ...
      >
        ...
        <p className={`mt-2 ${darkMode ? "text-gray-400" : "text-gray-500"}`}>
          The support ticket you are looking for does not exist or was removed.
        </p>
        <div className="mt-6">
          <button
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between">
              ...
              <div className="flex items-center text-sm">
                ...
                <span className={darkMode ? "text-gray-400" : "text-gray-500"}>
                  Created on {formatDate(ticket.createdAt)} at{" "}
        ...
        >
          ...
          <div className="p-6 divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <div className="pb-6">
              <div className="flex">
                <div
                  className={`h-10 w-10 rounded-full mr-3 flex items-center justify-center flex-shrink-0 ${
                    darkMode ? "bg-gray-700" : "bg-gray-200"
                  }`}
                >
                  <FaUser
              ...
              <div className="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                >
                  <p className="text-sm flex items-start">
                    ...
                    <span>
                      You are about to mark this ticket as resolved. The
                      customer will be notified. You can add a resolution note
                      below.
                    </span>
                  </p>
                </div>
