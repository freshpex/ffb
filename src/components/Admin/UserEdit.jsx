  ...
  useEffect(() => {
    if (user) {
      ...
      setFormData({
        ...
        tradingEnabled:
          user.tradingEnabled !== undefined ? user.tradingEnabled : true,
      });
    }
  }, [user]);
    ...
    return (
      ...
      >
        ...
        <p className={`mt-2 ${darkMode ? "text-gray-400" : "text-gray-500"}`}>
          There was an error loading the user details. Please try again.
        </p>
        <div className="mt-6">
          <button
  ...
  if (!user) {
    return (
      ...
      >
        ...
        <p className={`mt-2 ${darkMode ? "text-gray-400" : "text-gray-500"}`}>
          The user you are looking for does not exist or was deleted.
        </p>
        <div className="mt-6">
          <button
            onClick={() => navigate("/admin/users")}
            ...
            {saveSuccess && (
              ...
              >
                <p className="flex items-center">
                  <FaCheck className="mr-2" /> User information successfully
                  updated
                </p>
              </div>
            )}
