              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="mb-4">
                    ...
                    <p
                      className={`${darkMode ? "text-white" : "text-gray-900"} flex items-center`}
                    >
                  ...
                  >
                    ...
                    <div className="space-y-3">
                      {transaction.statusHistory.map((item, index) => (
                        <div
                          key={index}
                          className={`p-3 rounded ${darkMode ? "bg-gray-700" : "bg-white border border-gray-200"}`}
                        >
                          <div className="flex justify-between">
                            <div>
                              ...
                              >
                                Status changed from{" "}
                                <StatusBadge status={item.from} size="small" />{" "}
                                to <StatusBadge status={item.to} size="small" />
                              </p>
                              {item.note && (
                                <p
            ...
            >
              ...
              <div className="p-6">
                <div className="flex items-center mb-4">
                  ...
                  >
                    <FaUser
                      className={`h-6 w-6 ${darkMode ? "text-gray-500" : "text-gray-400"}`}
                    />
                  </div>
                  <div>
                    <p
              ...
              <div className="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                >
                  <p className="text-sm flex items-start">
                    ...
                    <span>
                      You are about to approve a {transaction.type} transaction
                      for{" "}
                      {formatCurrency(transaction.amount, transaction.currency)}
              ...
              <div className="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                >
                  <p className="text-sm flex items-start">
                    <FaInfoCircle className="h-5 w-5 mr-2 flex-shrink-0 mt-0.5" />
                    <span>
                      You are about to reject a {transaction.type} transaction
                      for{" "}
                      {formatCurrency(transaction.amount, transaction.currency)}
                      . This action cannot be undone.
                    </span>
