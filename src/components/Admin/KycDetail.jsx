...
const KycDetail = () => {
  ...
  if (status === 'loading') {
    return <ComponentLoader height="500px" message="Loading KYC request details..." />;
  }
  ...
  if (!kycRequest) {
    return (
      <div className={`rounded-lg p-8 text-center ${darkMode ? 'bg-gray-800' : 'bg-white'}`}>
        ...
        <h3 className={`text-lg font-medium ${darkMode ? 'text-white' : 'text-gray-900'}`}>KYC request not found</h3>
        <p className={`mt-2 ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>The KYC request you are looking for does not exist or was removed.</p>
        <div className="mt-6">
          <button
          ...
          <div className={`rounded-lg ${
            ...
            <div className="p-6">
              <div className="mb-6">
                ...
                <div className={`rounded-lg ${darkMode ? 'bg-gray-700' : 'bg-gray-50'} p-4 space-y-3`}>
                  <div className="flex justify-between">
                    <span className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>Status</span>
                    <StatusBadge status={kycRequest.status} />
                  </div>
                  <div className="flex justify-between">
                    <span className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>Submitted On</span>
                  ...
                  {kycRequest.rejectedBy && (
                    <div className="flex justify-between">
                      <span className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>Rejected By</span>
                      <span className={`text-sm font-medium ${darkMode ? 'text-white' : 'text-gray-900'}`}>
                        Admin
                      </span>
                    </div>
              ...
              <div className="mb-6">
                ...
                <div className={`rounded-lg ${darkMode ? 'bg-gray-700' : 'bg-gray-50'} p-4 space-y-3`}>
                  <div className="flex items-start">
                    <FaHome className={`mt-0.5 mr-3 h-4 w-4 ${darkMode ? 'text-gray-400' : 'text-gray-500'}`} />
                    <div>
                      <p className={`text-sm font-medium ${darkMode ? 'text-white' : 'text-gray-900'}`}>Address</p>
                      <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                        {kycRequest.information.address}, {kycRequest.information.city}, {kycRequest.information.postalCode}
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <FaGlobe className={`mt-0.5 mr-3 h-4 w-4 ${darkMode ? 'text-gray-400' : 'text-gray-500'}`} />
                    <div>
                      <p className={`text-sm font-medium ${darkMode ? 'text-white' : 'text-gray-900'}`}>Country</p>
                      <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                  ...
                  <div className="flex items-start">
                    <FaCalendarAlt className={`mt-0.5 mr-3 h-4 w-4 ${darkMode ? 'text-gray-400' : 'text-gray-500'}`} />
                    <div>
                      <p className={`text-sm font-medium ${darkMode ? 'text-white' : 'text-gray-900'}`}>Date of Birth</p>
                      <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>
              ...
              {kycRequest.status === 'pending' ? (
                ...
                <div className={`mt-4 p-4 rounded-lg ${
                  darkMode ? 'bg-red-900/30' : 'bg-red-50 border border-red-200'
                }`}>
              ...
              <div className="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                <div className={`mb-4 p-4 rounded-lg ${
                  ...
                  <p className="text-sm flex items-start">
                    ...
                    <span>
                      You are about to approve this user's KYC verification. This will give them full access to the platform's features. Are you sure?
                    </span>
                  </p>
                </div>
              </div>
              ...
              <div className="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                <div className={`mb-4 p-4 rounded-lg ${
                  ...
                  <p className="text-sm flex items-start">
                    <FaInfoCircle className="h-5 w-5 mr-2 flex-shrink-0 mt-0.5" />
                    <span>
                      You are about to reject this user's KYC verification. The user will be notified and will need to resubmit their documents. Please provide a reason.
                    </span>
                  </p>
                </div>
