...
import { checkAdminAuth, selectIsAdminAuthenticated } from '../../redux/slices/adminAuthSlice';
      ...
      <div className={`transition-all duration-300 ${
        ...
        <main className="flex-1 p-4 md:p-6 mp-16 lg:mb-0">
          <div className="container mx-auto">
            ...
            <p className="mt-2 text-gray-600 dark:text-gray-400">Manage your application settings and users.</p>
          </div>
          <Outlet />
        </main>
      </div>
