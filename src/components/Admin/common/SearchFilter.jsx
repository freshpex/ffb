  ...
  return (
    <div className={`flex flex-col sm:flex-row gap-3 ${className}`}>
      ...
      <div className="relative flex-1">
        ...
        <input
          type="text"
          className={`block w-full pl-10 pr-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${darkMode ? "border-gray-700 bg-gray-800 text-white placeholder-gray-400" : "border-gray-300 bg-white text-gray-700 placeholder-gray-400"}`}
          ...
          >
                  ...
                  <div className="space-y-2">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full rounded px-2 py-1 text-sm ${darkMode ? "bg-gray-700 border border-gray-600 text-white" : "bg-white border border-gray-300 text-gray-700"}`}
                      />
                    </div>
                    <div>
                      <label className={`${darkMode ? "block text-gray-400" : "block text-gray-600"} text-xs mb-1`}>
                    ...
                    {category.options.map((option) => (
                      <div key={option.value} className="flex items-center">
                        <input
                          ...
                          className={`h-4 w-4 rounded text-blue-600 focus:ring-blue-500 ${darkMode ? "border-gray-600 bg-gray-700" : "border-gray-300 bg-white"}`}
                        />
                        <label
            ...
            <div className="p-3 flex items-center justify-between">
              <button
                ...
                className={`${darkMode ? "text-gray-400 hover:text-white" : "text-gray-600 hover:text-gray-800"} text-sm`}
              >
                Clear All
              </button>
              <button
