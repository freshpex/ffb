...
const OrderForm = ({
  ...
  const isValid = () => {
    ...
    if (orderSide === "buy" && parseFloat(orderTotal) > availableBalance)
      return false;
    if (orderSide === "sell" && parseFloat(orderAmount) > baseAssetAvailable)
      return false;
  ...
  useEffect(() => {
    ...
    try {
      ...
      const numPrice =
        orderType === "market" ? currentPrice : parseFloat(orderPrice) || 0;
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4 text-xs">
          {orderSide === "buy" ? (
            ...
            <div className="flex justify-between">
              <span>Available:</span>
              <span className="font-medium">
                {baseAssetAvailable.toFixed(8)} {baseAsset}
              </span>
            </div>
          )}
        </div>
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            ...
            />
            {orderSide === "sell" &&
              parseFloat(orderAmount) > baseAssetAvailable && (
        ...
        <div className="mb-6">
          ...
          <div className="relative">
            ...
            />
            {orderSide === "buy" &&
              parseFloat(orderTotal) > availableBalance && (
                <div className="absolute right-3 top-3 text-red-500">
                  <FaExclamationTriangle />
                </div>
              )}
