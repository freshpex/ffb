        ...
        const mockResources = [
          {
            ...
            description:
              "Learn the basics of cryptocurrency, blockchain technology, and how it's changing the financial world.",
            type: "article",
            category: "beginner",
            level: "beginner",
            date: "2025-04-01",
          ...
          },
          {
            ...
            description:
              "Master advanced trading techniques used by professional traders in the cryptocurrency market.",
            type: "article",
            category: "advanced",
            level: "advanced",
            date: "2025-03-15",
          ...
          },
          {
            ...
            description:
              "Learn how to read charts and use technical indicators to improve your trading results.",
            type: "video",
            category: "intermediate",
            level: "intermediate",
            date: "2025-02-20",
          ...
          },
          {
            ...
            description:
              "Everything you need to know about Non-Fungible Tokens and their impact on digital ownership.",
            type: "video",
            category: "beginner",
            level: "beginner",
            date: "2025-03-25",
          ...
          },
          {
            ...
            description:
              "Join our expert traders for a live session analyzing current market conditions and trading opportunities.",
            type: "webinar",
            category: "advanced",
            level: "advanced",
            date: "2025-04-08",
          ...
          },
          {
            ...
            description:
              "Learn proven strategies to protect your capital and manage risk effectively in volatile markets.",
            type: "webinar",
            category: "intermediate",
            level: "intermediate",
            date: "2025-03-30",
          ...
          },
          {
            ...
            description:
              "Understanding tax implications of cryptocurrency trading and how to stay compliant.",
            type: "webinar",
            category: "intermediate",
            level: "intermediate",
            date: "2025-02-28",
        ...
        const mockCourses = [
          {
            ...
            description:
              "Learn the essentials of cryptocurrency trading from beginner to advanced concepts.",
            category: "trading",
          ...
          },
          {
            ...
            description:
              "Master blockchain technology and build your own decentralized applications.",
          ...
          },
          {
            ...
            description:
              "Discover how to invest in decentralized finance protocols and maximize your returns.",
            category: "investment",
        ...
        if (state.resources.length === 0) {
          ...
          const mockResources = [
            ...
            },
            {
              ...
              readTime: "12 min",
              content:
                "<p>This guide covers advanced trading strategies used in cryptocurrency markets.</p>",
            },
            {
              id: "3",
              title: "Understanding Market Cycles",
              ...
              readTime: "8 min",
              content:
                "<p>Financial markets tend to move in cycles, with periods of growth followed by periods of decline.</p>",
            },
          ];
...
export const selectFeaturedResources = (state) =>
  state.education.featuredResources;
