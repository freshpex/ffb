...
export const fetchVisitorDetails = createAsyncThunk(
  ...
  async (visitorId, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.get(`${API_URL}/tracking/${visitorId}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
...
// Export actions
export const { resetVisitorAnalytics, resetSelectedVisitor } =
  visitorSlice.actions;

// Export selectors
export const selectVisitorAnalytics = (state) =>
  state.visitorAnalytics.visitorAnalytics;
export const selectVisitorAnalyticsStatus = (state) =>
  state.visitorAnalytics.visitorAnalyticsStatus;
export const selectVisitorAnalyticsError = (state) =>
  state.visitorAnalytics.visitorAnalyticsError;

export const selectVisitors = (state) => state.visitorAnalytics.visitors;
export const selectVisitorsPagination = (state) =>
  state.visitorAnalytics.visitorsPagination;
export const selectVisitorsStatus = (state) =>
  state.visitorAnalytics.visitorsStatus;
export const selectVisitorsError = (state) =>
  state.visitorAnalytics.visitorsError;

export const selectSelectedVisitor = (state) =>
  state.visitorAnalytics.selectedVisitor;
export const selectSelectedVisitorStatus = (state) =>
  state.visitorAnalytics.selectedVisitorStatus;
export const selectSelectedVisitorError = (state) =>
  state.visitorAnalytics.selectedVisitorError;
