...
export const addSupportTicketReply = createAsyncThunk(
  ...
  async ({ id, message }, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error.message || "Failed to add reply to support ticket",
      );
    }
  },
);
...
export const fetchSupportTicketStats = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error.message || "Failed to fetch support ticket statistics",
      );
    }
  },
);
...
// Export actions
export const { clearSelectedTicket, clearSupportError } =
...
export const selectSelectedTicket = (state) =>
  state.adminSupport.selectedTicket;
