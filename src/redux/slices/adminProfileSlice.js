  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error.message || "Failed to fetch admin preferences",
      );
    }
  },
);
...
export const updateAdminPreferences = createAsyncThunk(
  ...
  async (preferences, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error.message || "Failed to update admin preferences",
      );
    }
  },
);
...
export const selectAdminProfileActionStatus = (state) =>
  state.adminProfile.actionStatus;
