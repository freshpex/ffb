...
export const updatePassword = createAsyncThunk(
  ...
  async (passwordData, { rejectWithValue }) => {
    try {
      const response = await apiClient.put('/api/users/security/password', passwordData);
...
export const verify2FA = createAsyncThunk(
  ...
  async (verificationData, { rejectWithValue }) => {
    try {
      const response = await apiClient.post('/api/users/security/2fa/verify', verificationData);
      return response.data;
    } catch (error) {
...
export const disable2FA = createAsyncThunk(
  ...
  async (verificationData, { rejectWithValue }) => {
    try {
      const response = await apiClient.post('/api/users/security/2fa/disable', verificationData);
      return response.data;
    } catch (error) {
