  ...
  async (params = {}, { rejectWithValue }) => {
    try {
      ...
      const response = await fetch(
        `${API_URL}/admin/analytics/users?${queryParams}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
      ...
      return rejectWithValue(
        error.message || "Failed to fetch user growth analytics",
      );
    }
  },
);
...
export const fetchFinancialAnalytics = createAsyncThunk(
  ...
  async (params = {}, { rejectWithValue }) => {
    try {
      ...
      const response = await fetch(
        `${API_URL}/admin/analytics/financial?${queryParams}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
...
export const fetchTransactionAnalytics = createAsyncThunk(
  ...
  async (params = {}, { rejectWithValue }) => {
    try {
      ...
      const response = await fetch(
        `${API_URL}/admin/analytics/transactions?${queryParams}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
...
export const selectUserGrowthAnalytics = (state) =>
  state.adminAnalytics.userGrowth;
export const selectFinancialAnalytics = (state) =>
  state.adminAnalytics.financial;
export const selectTransactionAnalytics = (state) =>
  state.adminAnalytics.transactions;
export const selectPerformanceAnalytics = (state) =>
  state.adminAnalytics.performance;

export const selectAnalyticsStatus = (state, section) =>
  state.adminAnalytics.status[section];
export const selectAnalyticsError = (state, section) =>
  state.adminAnalytics.error[section];
export const selectAnalyticsLastFetched = (state, section) =>
  state.adminAnalytics.lastFetched[section];
